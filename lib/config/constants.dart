...
class GameColors {
  ...
  static const Color secondary = Color(0xFF3a2351);
  static const Color accent = Color(0xFF7851a9);
  static const Color success = Color(0xFFc2a4cf);
  static const Color warning = Color(0xFFdcd6f7);
